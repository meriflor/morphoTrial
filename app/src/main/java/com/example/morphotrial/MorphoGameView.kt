...
class MorphoGameView(context: Context, private val size: Point) : SurfaceView(context), Runnable {
    ...
    private var bitmap1: Bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.background)
    private val px = size.x
    private val py = size.y
    private val rect: Rect = Rect(0, 0, px, py)
